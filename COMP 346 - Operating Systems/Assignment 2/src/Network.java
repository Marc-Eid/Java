...
public class Network extends Thread {
  ...
  //semaphores
    static Semaphore mutexIn;
    static Semaphore mutexOut;
   
    static Semaphore emptyIn;
    static Semaphore emptyOut;
   
    static Semaphore fullIn;
    static Semaphore fullOut;   
     ...
     */
     ...
     public static void writeToOutputFile(String message){
     	try {
     		...
     		System.out.println("An error occurred while writing or opening the file. \nProgram will stop now!");
     		System.exit(1);
     	}
     }
     ...
     */
        ...
        //	System.out.println("\n DEBUG : Network.send() - account number " + inComingPacket[inputIndexClient].getAccountNumber());
        	...
        	fullIn.release();
        	mutexIn.release();//should be the opposite 
        	return true;
        }   
