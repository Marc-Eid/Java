...
public class Client extends Thread { 
	...
	public void readTransactions()
	{
		...
		catch(FileNotFoundException e)
		{
			...
			Network.writeToOutputFile("File transaction.txt was not found");
			System.out.println("or could not be opened.");
			Network.writeToOutputFile("or could not be opened.");
			System.exit(0);
		}
		while (inputStream.hasNextLine( ))
		{
			...
			catch(InputMismatchException e)
			{
				...
				Network.writeToOutputFile("Line " + i + "file transactions.txt invalid input");
				System.exit(0);
			}
...
//			}
		...
		//	System.out.println("\n DEBUG : Client.receiveTransactions() - receiving updated transaction on account " + transact.getAccountNumber());
			...
			Network.writeToOutputFile(transact.toString());
			i++;
		} 
	}
