...
public class Client extends Thread { 
	...
	public void readTransactions()
	{
		...
		catch(FileNotFoundException e)
		{
			...
			objNetwork.writeToOutputFile("File transaction.txt was not found");
			System.out.println("or could not be opened.");
			objNetwork.writeToOutputFile("or could not be opened.");
		...
		while (inputStream.hasNextLine( ))
		{
			...
			catch(InputMismatchException e)
			{
				...
				objNetwork.writeToOutputFile("Line " + i + "file transactions.txt invalid input");
				System.exit(0);
			}
	...
	public void receiveTransactions(Transactions transact)
	{
		...
		//	System.out.println("\n DEBUG : Client.receiveTransactions() - receiving updated transaction on account " + transact.getAccountNumber());
			...
			objNetwork.writeToOutputFile(transact.toString());
			i++;
		} 
	}
