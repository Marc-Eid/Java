...
public class CityBus extends PublicTransportation{
	...
	{// the result variable is to store the driver names. the conditions below are to add commas(,) and (and) if there is more than one driver 
		...
		return ("This city bus has " + nbOfStops + " stops, and costs " + ticketPrice +
	...
	public boolean equals(Object otherObject)
	{
		...
		else //we use the names of the attributes of the parent class since they are set to protected
		{
			CityBus otherBus = (CityBus) otherObject;
			return (ticketPrice == otherBus.ticketPrice && this.nbOfStops == otherBus.nbOfStops && routeNumber == otherBus.routeNumber
