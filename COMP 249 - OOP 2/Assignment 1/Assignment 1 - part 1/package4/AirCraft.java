...
public class AirCraft extends PublicTransportation {
	...
	{	
		String period = maintanencePeriod.toString(); // this is to convert the enum variables to string to make it in lowercase before printing
		period = period.toLowerCase();
		
		String type = airCraft.toString();
		type = type.toLowerCase();
		
		return ("This Aircraft has " + nbOfStops + " stop(s) and costs " + ticketPrice +
	...
	public boolean equals(Object otherObject)
	{
		...
		else
		{
			...
			return (ticketPrice == otherAirCraft.ticketPrice && this.nbOfStops == otherAirCraft.nbOfStops && this.airCraft == otherAirCraft.airCraft 
